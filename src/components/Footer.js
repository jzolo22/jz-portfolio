...
function Footer(){
    ...
    return (
        <StyledDiv> 
            <a target="_blank" href="https://github.com/jzolo22" >
                <StyledImg src="/images/githubIcon.png" alt="github logo"/>
            </a>
            
            <a target="_blank" href="https://www.linkedin.com/in/jzolotarev/" >
                <StyledImg src="/images/linkedinIcon.png" alt="linkedin logo"/>
            </a>

            <a target="_blank" href="https://twitter.com/JZolo" >
                <StyledImg src="/images/twitterIcon.png" alt="twitter logo"/>
            </a>  

            <a target="_blank" href="https://jzolotarev.medium.com/" >
                <StyledImg src="/images/mediumIcon.png" alt="medium logo"/>
            </a>   

            <a target="_blank" href="https://www.youtube.com/channel/UCEZuU86dwUCBBkLUr24e6GA/videos" >
